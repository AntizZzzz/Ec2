...
public class MeibaoIncomingPop{
	private static final Logger logger = LoggerFactory.getLogger(MeibaoIncomingPop.class);
	...
	public static Boolean incomingPop(Boolean ispush,String exten, String calleridnum) {
		...
		try {
			//建立指定url的Http连接
			URL url = new URL("http://192.168.1.131/mbcrm/Home/Call/receiveCallWin/"); //美宝之家专用，所以写死
			String params= "extennum="+exten+"&calleridnum="+calleridnum;
logger.info("meibao incomingpop--> extennum:"+exten+" calleridnum:"+calleridnum);
