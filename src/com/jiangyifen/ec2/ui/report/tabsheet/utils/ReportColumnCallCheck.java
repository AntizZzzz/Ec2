...
public class ReportColumnCallCheck extends VerticalLayout {
	...
	public ReportColumnCallCheck(String mainTitle, String yAxisTitle,
			String firstXySeriesName, String secondXySeriesName,
			String thirdXySeriesName, List<String> xAxis,
			List<Double> doubles1, List<Double> doubles2, List<Double> doubles3) {

		System.out.println("doubles1.size() =========> " + doubles1.size());
		System.out.println("doubles2.size() =========> " + doubles2.size());
		System.out.println("doubles3.size() =========> " + doubles3.size());
		...
		seriesDate = new XYSeries(thirdXySeriesName, maleScatterCfg);
		seriesDate.setSeriesPoints(getPoints(seriesDate, doubles3));
