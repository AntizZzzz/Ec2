...
public class ReportColumnUtil extends VerticalLayout {
	...
	public ReportColumnUtil(String mainTitle, String yAxisTitle,
			String xySeriesName, List<String> xAxis, List<Double> datas) {

		System.out.println("=====ReportColumnUtil==========");
		...
		seriesDate = new XYSeries(xySeriesName);
