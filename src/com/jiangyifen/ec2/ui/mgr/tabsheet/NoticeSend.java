...
import com.jiangyifen.ec2.ui.mgr.messagesend.CsrTree;
import com.jiangyifen.ec2.ui.mgr.messagesend.SelectCsr;
...
public class NoticeSend  extends VerticalLayout implements Button.ClickListener{
/**
 * 主要组件
 */
	//消息组件
     ...
     * 弹出窗口
     */
    private SelectCsr selectCsrWindow;
	 ...
	 * 构造器
	 */
	public NoticeSend(MgrTabSheet mgrTabSheet) {
		this.setSizeFull();
		...
		CsrTree treeComponent = new CsrTree(this);
...
//		constraintButtonsLayout.addComponent(viewHistory);
	...
	private void showSelectCsrWindow() {
		if(selectCsrWindow==null){
			selectCsrWindow=new SelectCsr(this);
		}
	...
	private void executeSend() {
		...
		NotificationUtil.showWarningNotification(this,"成功给"+selectedCsrs.size()+"个CSR发送了通知!");
