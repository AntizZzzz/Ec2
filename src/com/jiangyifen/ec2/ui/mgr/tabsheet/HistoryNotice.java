...
import com.jiangyifen.ec2.ui.mgr.messagesend.EditNotice;
import com.jiangyifen.ec2.ui.mgr.messagesend.PreView;
...
public class HistoryNotice  extends VerticalLayout implements 
	 ...
	 * 构造器
	 */
	public HistoryNotice(MgrTabSheet mgrTabSheet) {
		this.setSizeFull();
...
//		// jrh 只能查看自己发送的消息
//		SqlGenerator.Equal equal = new SqlGenerator.Equal("sender.id", loginUser.getId().toString(), false);
