...
public class EditKnowledgeWindow extends Window implements ClickListener {
	...
	public EditKnowledgeWindow(KnowledgeManagement knowledgeManagement) {
	...
	public void attach() {
		super.attach();
		knowledge=(Knowledge)knowledgeManagement.getTable().getValue();
		titleField.setValue(knowledge.getTitle());
		contentArea.setValue(knowledge.getContent());
	}
	...
	public void buttonClick(ClickEvent event) {
		if (event.getButton() == save) {
			try {
				...
				e.printStackTrace();
				this.getApplication().getMainWindow().showNotification("编辑失败");
			}
