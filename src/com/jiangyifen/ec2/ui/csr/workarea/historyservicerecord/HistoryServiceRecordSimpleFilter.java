...
public class HistoryServiceRecordSimpleFilter extends VerticalLayout implements ClickListener {
	...
	private HistoryServiceRecordComplexFilter recordComplexFilter;					// 存放高级收索条件的组件
	private FlipOverTableComponent<CustomerServiceRecord> tableFlipOver;	// 我的客服记录显示表格的翻页组件
	
	public HistoryServiceRecordSimpleFilter() {
	...
	private void createOperateUI() {
		...
		// 高级搜索
		recordComplexFilter = new HistoryServiceRecordComplexFilter();
	...
	private String  createCountSql() {
		...
		// 拼接查询语句
		String dynamicSql = " and c.creator.id = " +loginUser.getId() + customerPhoneSql + specificStartTimeSql + specificFinishTimeSql + projectSql + taskFinishedStatuSql;
