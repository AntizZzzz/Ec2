...
public class CsrCsrTree extends HorizontalLayout implements Property.ValueChangeListener {
	
	private Tree tree;
	//private DepartmentService departmentService;
	private HashMap<Long, List<User>> deptCsr;
	private CsrNoticeSend messageSend;
	private User loginUser;
	
	// 构造器
	public CsrCsrTree(CsrNoticeSend messageSend) {
...
//		this.setMargin(false, true, false, false);
	...
	private HierarchicalContainer createTreeContainer() {
		...
		allGovernedDepts.add(loginUser.getDepartment());
