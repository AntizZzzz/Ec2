...
public class CsrEditNotice extends Window implements Button.ClickListener {
	/**
	 * 主要组件
	 */
	// 消息组件
	 ...
	 * 编辑消息窗口
	 */
	public CsrEditNotice(CsrNoticeHistory historyMessage) {
		this.center();
		this.setModal(true);
	...
	private void executeSave() {
		...
		if(titleStr.trim().equals("")){
			this.getWindow().showNotification("消息标题不能为空");
			return;
		}
		// 内容
		String contentStr = "";
