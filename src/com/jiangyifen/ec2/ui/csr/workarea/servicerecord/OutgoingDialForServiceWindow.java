...
public class OutgoingDialForServiceWindow extends Window implements CloseListener {
	...
	private ServiceOutgoingRecordCreator serviceOutgoingRecordCreator;			// 外呼结果的创建界面
	...
	public OutgoingDialForServiceWindow() {
...
//		customerBaseInfoView.setCustomerInfoPanelHeight("165px");
		...
		// 创建客服记录
		serviceOutgoingRecordCreator = new ServiceOutgoingRecordCreator(this);
