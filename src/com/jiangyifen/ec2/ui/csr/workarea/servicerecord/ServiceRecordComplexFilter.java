...
public class ServiceRecordComplexFilter extends VerticalLayout implements ClickListener, ValueChangeListener, Content {
	...
	public ServiceRecordComplexFilter() {
	...
	private String  createCountSql() {
		...
		String sql = " c.creator.id = "+loginUser.getId() + customerIdSql + customerPhoneSql + specificStartOrderTimeSql + specificFinishOrderTimeSql
