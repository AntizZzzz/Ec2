...
public class ServiceOutgoingRecordCreator extends VerticalLayout implements ClickListener, ValueChangeListener {
	// 日志工具
	...
	private OutgoingDialForServiceWindow outgoingDialForServiceWindow;							// 呼叫弹出窗口
	...
	public ServiceOutgoingRecordCreator(OutgoingDialForServiceWindow outgoingDialForServiceWindow) {
		this.setSpacing(true);
		this.outgoingDialForServiceWindow = outgoingDialForServiceWindow;
...
//		outgoingRecordStatuses = serviceRecordStatusService.getAllByDirection(loginUser.getDomain(), "outgoing");
	...
	private boolean saveChanges() {
		...
		boolean isSaveResourceSuccess = outgoingDialForServiceWindow.checkAndSaveCustomerResourceInfo();
	...
	private void createOutgoingRecord(Date orderTime, String orderNote, MarketingProject currentWorkingProject, CustomerResource customerResource) {
		...
		String recordFileName = dateStr+"-"+outgoingDialForServiceWindow.getAgiChannel().getUniqueId()+".wav";
