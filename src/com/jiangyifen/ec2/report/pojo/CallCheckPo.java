...
public class CallCheckPo {
	...
	private String callAvgRingTimeLength;// 平均振铃时长
	private int missCount;// 漏接数量
	...
	public String getCallAvgRingTimeLength() {
		return callAvgRingTimeLength;
	}

	public void setCallAvgRingTimeLength(String callAvgRingTimeLength) {
