...
public class Common_ShowTableMainFeaturesTest extends VerticalLayout {
    ...
    public Common_ShowTableMainFeaturesTest() {
        addComponent(table);
        ...
        // connect data source
        table.setContainerDataSource(Common_ExampleUtilTest.getISO3166Container());
        ...
        table.setColumnIcon(Common_ExampleUtilTest.iso3166_PROPERTY_FLAG,
                new ThemeResource("../sampler/icons/action_save.gif"));
        table.setColumnIcon(Common_ExampleUtilTest.iso3166_PROPERTY_NAME,
                new ThemeResource("../sampler/icons/icon_get_world.gif"));
        table.setColumnIcon(Common_ExampleUtilTest.iso3166_PROPERTY_SHORT,
                new ThemeResource("../sampler/icons/page_code.gif"));

        // Column alignment
        table.setColumnAlignment(Common_ExampleUtilTest.iso3166_PROPERTY_SHORT,
                Table.ALIGN_CENTER);

        // Column width
        table.setColumnExpandRatio(Common_ExampleUtilTest.iso3166_PROPERTY_NAME, 1);
        table.setColumnWidth(Common_ExampleUtilTest.iso3166_PROPERTY_SHORT, 70);

        // Collapse one column - the user can make it visible again
        table.setColumnCollapsed(Common_ExampleUtilTest.iso3166_PROPERTY_FLAG, true);

        // show row header w/ icon
        table.setRowHeaderMode(Table.ROW_HEADER_MODE_ICON_ONLY);
        table.setItemIconPropertyId(Common_ExampleUtilTest.iso3166_PROPERTY_FLAG);
                ...
                if (ACTION_MARK == action) {
                    ...
                    addComponent(new Label("Saved: "
                            ...
                            + item.getItemProperty(
                                    Common_ExampleUtilTest.iso3166_PROPERTY_NAME)
                                    .getValue()));
                }
        ...
        table.setCellStyleGenerator(new CellStyleGenerator() {
            public String getStyle(Object itemId, Object propertyId) {
                ...
                } else if (Common_ExampleUtilTest.iso3166_PROPERTY_NAME.equals(propertyId)) {
                    return "bold";
                } else {
                    // no style
                    return null;
