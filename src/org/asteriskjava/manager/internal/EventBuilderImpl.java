...
//    	TODO
//    	----------------
//    	if(attributes.get("event").equals("CEL")){
//    		System.err.println(attributes.get("eventname")+"------>"+attributes);
//    	}
//    	if(attributes.get("event").equals("CEL")){
//    		if(attributes.get("application") != null && attributes.get("application").equals("Queue")){
//    			System.err.println(attributes.get("eventname")+"------>"+attributes);
//    		}
//    	}
...
//    	----------------
        ...
        {
        	System.out.println(attributes.get("event"));
