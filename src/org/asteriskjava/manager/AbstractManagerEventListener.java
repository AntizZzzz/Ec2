...
public abstract class AbstractManagerEventListener implements
	...
	protected void handleEvent(AgentRingNoAnswerEvent event) {
	}
	...
	public void onManagerEvent(ManagerEvent event) {
		if (event instanceof QueueSummaryEvent) {
			handleEvent((QueueSummaryEvent) event);
		} else if (event instanceof QueueSummaryCompleteEvent) {
			handleEvent((QueueSummaryCompleteEvent) event);
		}
		// TODO lc add
			...
			handleEvent((AgentRingNoAnswerEvent) event);
